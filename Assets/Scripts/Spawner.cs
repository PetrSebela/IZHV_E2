...
public class Spawner : MonoBehaviour
{
    ...
    /// </summary>
    [SerializeField] float _speedIncreaseOverTime = 1.1f;

    /// <summary>
    /// Stores global obstacle speed multiplier.
    /// </summary>
    private float _compoundMultiplier = 1;

     /// <summary>
    /// Mean decrese multiplier. The game gets exponentialy more faster. Probably should be linear, but i think it doesnt matter that much :)
    /// </summary>
    [SerializeField] float _meanDecreseMultiplier = 0.975f;
    [SerializeField] float _sizeIncreaseOverTime = 1.1f;
    ...
    void Update()
    {
        ...
        { // Check if we should spawn.
            ...
            { // Spawn at most one obstacle per frame.
                ...
                spawnFrequencyMean *= _meanDecreseMultiplier;
                spawnFrequencyStd *= _meanDecreseMultiplier;
    ...
    public void SpawnObstacle()
    {
        ...
        spawnSize *= _sizeIncreaseOverTime;

        obstacle.GetComponent<Rigidbody2D>().velocity *= _compoundMultiplier;
        _compoundMultiplier *= _speedIncreaseOverTime;
